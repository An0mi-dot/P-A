...
This file documents releases made in the repository. Use `npm run bump-version` to bump
the version following the project's rule (patch increments up to 9, then minor++). The
script will append a new entry for the current version with the commit message and short SHA.
## v1.0.1 - 2026-01-21

- Commit: c1a60c5
- Notes: chore: add bump-version script and VERSIONS.md
## v1.0.2 - 2026-01-21

- Commit: 30452a1
- Notes: ci: add auto-bump workflow (on release label or [release] commit)
## v1.0.3 - 2026-01-21
...
- Notes: feat(rbac): Implementa sistema de cargos (Admin, Tester, Pastas) com gest�o via interface
## v2.0.7 - 2026-03-04
...
- Commit: c06bd5d
- Notes: chore(site): align download metadata with v3.0.1
## v3.0.3 - 2026-05-27

- Commit: 3d786d0
- Notes: fix(site): use app icon as favicon
## v3.0.4 - 2026-07-21

- Commit: 4d2324e
- Notes: Add portal website (GitHub Pages)
## v3.0.5 - 2026-07-21
